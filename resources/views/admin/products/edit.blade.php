                                ...
                                <div class="lg:flex lg:items-start">
                                    <div class="lg:order-2 lg:ml-5">
                                        <div class="max-w-xl overflow-hidden rounded-lg">
                                           <input type="file" name="image" id="image" value="{{old('image', $product->image)}}"></input>
                                ...
                                <div class="mt-10 flex flex-col items-center justify-between space-y-4 border-t border-b py-4 sm:flex-row sm:space-y-0 grid grid-rows-3">
                                    <div class="flex items-end row-span-3">
                                        <h1 class="text-3xl font-bold">€
                                            <input name="price" type="text" id="price" value="{{$product->price}}" placeholder="Prijs" class="shadow-sm bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-black dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
                                            @error('price')
                                            <p class="text-red text-xs mt-2">{{$message}}</p>
                                            @enderror
                                        </h1>
                                    ...
                                    <div class="row-span-1 py-2">
                                        <input name="url" type="text" id="url" value="{{$product->url}}" placeholder="URL Webshop Product" class="shadow-sm bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-black dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
                                        @error('url')
                                        <p class="text-red text-xs mt-2">{{$message}}</p>
                                        @enderror
                                    </div>
...
{{--                                    </li>--}}
                                    ...
                                    <li>
                                        <input name="materials" type="text" id="materials" value="{{$product->materials}}" placeholder="(Glas, Hout, Metaal, ...)" class="shadow-sm bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-black dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
                                        @error('materials')
                                        <p class="text-red text-xs mt-2">{{$message}}</p>
                                        @enderror
                                    </li>
                                    <li>
                                        <input name="slug" type="text" id="slug" value="{{$product->slug}}" placeholder="slug" class="shadow-sm bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-black dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
                                        @error('slug')
                                        <p class="text-red text-xs mt-2">{{$message}}</p>
                                        @enderror
                                    </li>
                            ...
                            <div class="lg:col-span-3 mx-10">
                                ...
                                <div class="mt-8 flow-root sm:mt-12">
                                    ...
                                    <p class="mt-4">
                                        <input name="excerpt" type="text" id="excerpt" value="{{$product->excerpt}}" placeholder="Tekst 1" class="shadow-sm bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-black dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required>
                                    ...
                                    @enderror
                                    <p class="mt-4">
                                        <input name="extra" type="text" id="extra" value="{{$product->extra}}" placeholder="Tekst 3 (mag leeggelaten worden)" class="shadow-sm bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-white dark:border-gray-600 dark:placeholder-black dark:text-black dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">
                    ...
                    <div class="py-4 px-4">
        <button type="submit" class="text-white bg-blue-300 hover:bg-blue-500 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-300 dark:hover:bg-blue-500 dark:focus:ring-blue-500">Wijzig product</button>
                    </div>
                </section>
    </form>
</main>
